...
function Router() {
  return (
    <Switch>
      ...
      {/* ── Auth-required routes — wrapped in AppLayout + ProtectedRoute ── */}
      <Route>
        <ProtectedRoute>
          <AppLayout>
            <Switch>
              ...
              {FEATURES.sphinxAdvanced && (
                <Route
                  path="/marketplace/synergy"
                  component={MarketplacePage}
                />
              )}
              {FEATURES.sphinxAdvanced && (
                <Route
                  path="/marketplace/roundtable"
                  component={MarketplacePage}
                />
              )}
              {FEATURES.sphinxAdvanced && (
                <Route
                  path="/marketplace/synthesis"
                  component={MarketplacePage}
                />
              )}
              {FEATURES.corporateMarketplace && (
                <Route
                  path="/marketplace/corporate"
                  component={MarketplacePage}
                />
              )}
              {FEATURES.forgeLabDocx && (
                <Route
                  path="/marketplace/forge-lab"
                  component={MarketplacePage}
                />
              )}
              {FEATURES.guinPublic && (
              ...
              {FEATURES.adminCcgeImport && (
                <Route
                  path="/admin/ccge-import"
                  component={AdminCcgeImportPage}
                />
              )}
              ...
              {FEATURES.trainingProviders && (
                <Route
                  path="/training/p/:slug"
                  component={TrainingProviderDetailPage}
                />
              )}
              {FEATURES.trainingProviders && (
              ...
              {FEATURES.matchmaking && (
                <Route
                  path="/matchmaking/:id"
                  component={MatchmakingDetailPage}
                />
              )}
              {FEATURES.matchmaking && (
      ...
      <QueryClientProvider client={queryClient}>
        <AuthProvider>
          <TooltipProvider>
            <Toaster />
            <Switch>
              {/* Shared report and invite confirm are public, no sidebar */}
